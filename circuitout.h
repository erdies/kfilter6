...
private:
    ...
    void drawEquivalentDriverCircuit(QPainter& painter, const QRectF& rect, int signalY, int returnY,
                                     qreal shuntStartX = -1.0, bool drawUpperShuntBus = false,
                                     qreal shuntBranchShiftX = 0.0) const;
    ...
    void drawEnclosureHatching(QPainter& painter, const QRectF& rect) const;
